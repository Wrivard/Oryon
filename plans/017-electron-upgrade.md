...
1. WebSearch : majeure stable Electron courante + notes de breaking changes 32→N
   (electronjs.org/docs/latest/breaking-changes) ; croiser CHAQUE point d'usage ci-dessus.
